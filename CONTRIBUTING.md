# Contributing to LlamaGpt Rs

Thank you for your interest in contributing to LlamaGpt Rs! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to LlamaGpt Rs:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llamagpt-rs.git
   cd llamagpt-rs
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llamagpt-rs.git
   ```
...
By contributing to LlamaGpt Rs, you agree that your contributions will be licensed under the project's MIT License.
